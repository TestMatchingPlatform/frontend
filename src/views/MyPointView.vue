        ...
        <v-card class="grey lighten-1 pa-5">
          ...
          <v-row>
            ...
            <v-col cols="6">
              <v-card class="pa-5">
                <v-card-text class="text-center text--primary font-weight-bold"
                  >{{ getMoneyFromChangePoint }}원</v-card-text
                >
              </v-card>
            </v-col>
          </v-row>
          <v-col cols="12"> <v-btn class="align-center">전환하기</v-btn></v-col>
        </v-card>
      </v-col>
    </v-row>
  </v-container>
